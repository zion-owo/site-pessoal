...
// dados do index
$data   = $messages['index'][$lang] ?? $messages['index']['pt'];
$notice = $data['notice'];
$btn    = $data['button'];
?>
...
<head>
  <meta charset="UTF-8">
  <title><?php echo htmlspecialchars(strtok($notice, "\n"), ENT_QUOTES); ?></title>
...
<body<?php echo $mode==='dark' ? ' class="dark"' : ''; ?>>
  ...
  <div class="index-container">
    ...
    <a class="real-btn" href="starting-point.php?lang=<?php echo $lang ?>&mode=<?php echo $mode ?>">
