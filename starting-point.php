...
//titulos especificos da pagina
$msg = [
  'pt' => [
    'pageTitle' => "início - hazwitz",
  ],
  'en' => [
    'pageTitle' => "home - hazwitz",
  ],
  'de' => [
    'pageTitle' => "startseite - hazwitz",
  ],
];

// dados da página
$pageKey     = 'inicio';
$pageData    = $messages['pages'][$pageKey][$lang] ?? $messages['pages'][$pageKey]['pt'];
$title       = $pageData['title'];
$title2      = $pageData['title2'];
$comment1    = $pageData['comment1'];
$placeholder = $pageData['placeholder'];
$pageTitle  = $msg[$lang]['pageTitle'] ?? $msg['pt']['pageTitle'];
?>
<!DOCTYPE html>
...
<body<?php echo $mode==='dark' ? ' class="dark"' : ''; ?>>
  ...
  <div class="content-frame">
    <main class="site-content">
      ...
      <h1><?php echo htmlspecialchars($title2, ENT_QUOTES) ?></h1>
      <p><?php echo nl2br(htmlspecialchars($comment1, ENT_QUOTES)) ?></p>
    </main>
  </div>
